...
SECRET_KEY = 'uj)6m(1@s)=9c3&-h-)xl5wx4j^e960&)s$2nd85rawf^&8ids'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            os.path.join(BASE_DIR, 'wechatserver/templates')
        ]
        ,
        'APP_DIRS': True,
        'OPTIONS': {
...
LOGGING = {
    ...
    'formatters':{
        ...
        'django_request':{
            'format':'%(levelname)s %(asctime)s %(status_code)d %(request)s %(module)s %(process)d %(thread)s %(message)s'
        }
    },
    'handlers':{
        'null':{
